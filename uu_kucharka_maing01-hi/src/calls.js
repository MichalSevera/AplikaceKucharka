...
const Calls = {
  ...
  updateRecipe(dtoIn) {
    console.log("calling updateRecipe", dtoIn);
    return instance.put("recipe/update", dtoIn);
  },
  ...
  setStar(dtoIn) {
    console.log("calling setStar", dtoIn);
    return instance.put("recipe/setstar", dtoIn);
  },
